...
-module(elixirml_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/elixirml_lexer.xrl", 24).
...
-file("src/elixirml_lexer.erl", 303).
yystate() -> 16.
...
yystate(20, [10|Ics], Line, Tlen, _, _) ->
    yystate(20, Ics, Line+1, Tlen+1, 0, Tlen);
...
yystate(16, [106|Ics], Line, Tlen, Action, Alen) ->
...
yystate(16, [41|Ics], Line, Tlen, Action, Alen) ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [37|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [38|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
...
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 60, C =< 62 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 98, C =< 104 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 110, C =< 113 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 115, C =< 118 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 120, C =< 122 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
...
yystate(12, [33|Ics], Line, Tlen, _, _) ->
    yystate(12, Ics, Line, Tlen+1, 3, Tlen);
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 60, C =< 62 ->
    yystate(12, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(19, Ics, Line, Tlen+1, 6, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 105, C =< 122 ->
    yystate(19, Ics, Line, Tlen+1, 6, Tlen);
...
-file("src/elixirml_lexer.xrl", 13).
yyaction_0(TokenChars, TokenLine) ->
     { token, { whitespace, TokenLine, length (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("src/elixirml_lexer.xrl", 14).
yyaction_1(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("src/elixirml_lexer.xrl", 15).
yyaction_2(TokenChars, TokenLine) ->
     { token, { float, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_3/2}).
-file("src/elixirml_lexer.xrl", 16).
yyaction_3(TokenChars, TokenLine) ->
     { token, { operator, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_4/2}).
-file("src/elixirml_lexer.xrl", 17).
yyaction_4(TokenChars, TokenLine) ->
     { token, { 'let%', TokenLine, lists : nthtail (4, TokenChars) } } .

-compile({inline,yyaction_5/2}).
-file("src/elixirml_lexer.xrl", 18).
yyaction_5(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_6/2}).
-file("src/elixirml_lexer.xrl", 19).
yyaction_6(TokenChars, TokenLine) ->
